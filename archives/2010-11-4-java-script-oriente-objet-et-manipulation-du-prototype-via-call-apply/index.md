...
Lors d'un précédent article sur <a href="{{site.baseurl}}assets/img/article/express-framework-web-node/">express</a>, j'ai eu l'occasion d'utiliser <a href="https://github.com/ajaxorg/node-github">node-github</a>, un module Node permettant de dialoguer avec l'API Rest de Github. Il dispose d'une API orienté objet et asynchrone. J'ai pu y découvrir un pattern, une manière de manipuler le prototype qui m'a particulièrement plu.
...
<img src="{{site.baseurl}}assets/img/js-oo-et-manipulation-prototype-via-call-apply/prototype-and-constructor.png" style="float: none"></img>
...
<img src="{{site.baseurl}}assets/img/js-oo-et-manipulation-prototype-via-call-apply/wo-new.png" alt="wo-new" title="" />
