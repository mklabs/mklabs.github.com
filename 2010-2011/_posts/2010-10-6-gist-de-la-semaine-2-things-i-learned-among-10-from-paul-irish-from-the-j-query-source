...
<img class="mk-blog-img" src="{{site.baseurl}}assets/img/things-learned-from-paul-irish/anonymous.png" />
...
<img class="mk-blog-img" src="{{site.baseurl}}assets/img/things-learned-from-paul-irish/badass-not-evals.png" alt="BadAss not evals" />
