...
<img class="mk-blog-img-center" src="{{site.baseurl}}assets/img/node-boilerplate/node-boilerplate-tree.png" alt="" />
...
<img class="mk-blog-img-center" src="{{site.baseurl}}assets/img/node-boilerplate/node-boilerplate-initproject.png" alt="" />
...
<img class="mk-blog-img-center" src="{{site.baseurl}}assets/img/node-boilerplate/node-boilerplate-run.png" alt="" />



Vous pourrez voir ce que cela donne en visitant <a href="http//localhost:8081">http//localhost:8081</a>

<img class="mk-blog-img-center" src="{{site.baseurl}}assets/img/node-boilerplate/node-boilerplate-test.png" alt="" />
...
<img class="mk-blog-img-right" src="{{site.baseurl}}assets/img/node-boilerplate/node-boilerplate-tree2.png" alt="" />
