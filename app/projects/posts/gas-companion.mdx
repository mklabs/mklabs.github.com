...
title: GAS Companion
publishedAt: '2021'
summary: Leveraging the power of the Gameplay Ability System, this plugin provides a starting point and a robust foundation to speed up the creation and development of GAS-based projects.
---
...
[**Marketplace link**](https://www.unrealengine.com/marketplace/en-US/product/gas-companion) / [**Documentation**](https://gascompanion.github.io/) / [**Example Project**](https://github.com/GASCompanion/GASCompanionDemo/releases) / [**Discord Server**](https://discord.gg/d4rs4vcX6t)
