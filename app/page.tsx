  ...
  return (
    <section>
      ...
      <p className="mb-4">
        ...
        <a className={linksClassnames} href="https://www.unrealengine.com/marketplace/en-US/product/gameplay-blueprint-attributes">Blueprint Attributes</a> plugins that can be found on FAB marketplace.
      </p>
